...
var glide = function glide(carousel) {
  var type = carousel.getAttribute('glide-type') || 'carousel';
  var perView = carousel.getAttribute('glide-perview') || 1;
  var gap = carousel.getAttribute('glide-gap') || 0;
  var bound = carousel.getAttribute('glide-bound') || true;
  var rewind = carousel.getAttribute('glide-rewind') || false;
  var animationDuration = carousel.getAttribute('glide-duration') || 500;
  var peek = {
    before: carousel.getAttribute('glide-peek') || 0,
    after: carousel.getAttribute('glide-peek') || 0
  };
  var glideObj = new _glidejs_glide__WEBPACK_IMPORTED_MODULE_0__["default"](carousel, {
    type: type,
    gap: gap,
    bound: bound,
    perView: perView,
  ...
  if (carousel.getAttribute('glide-perview-sm')) {
    glideObj.update({
      breakpoints: _objectSpread(_objectSpread({}, glideObj._o.breakpoints), {}, {
        375: {
...
var initGlide = function initGlide(carousels) {
