...
window.addEventListener('load', function () {
  ...
  document.querySelectorAll('[data-statamic-responsive-images]').forEach(function (responsiveImage) {
...
if (forms || forms.length) {
  forms.forEach(function (form) {
    ...
    var fileUploads = form.querySelectorAll('.file-upload');
    fileUploads.forEach(function (label) {
      var input = label.querySelector('input');
      var handle = label.getAttribute('data-for');
      var name = form.querySelector("#".concat(handle, "-name"));
...
if (accordions || accordions.length) {
  accordions.forEach(function (accordion) {
    var container = accordion.parentElement.parentElement;
    var accordionGroup = container.querySelectorAll('.accordion') ? container.querySelectorAll('.accordion') : 0;
    accordion.addEventListener("click", function () {
      var wrapper = accordion.parentElement;
